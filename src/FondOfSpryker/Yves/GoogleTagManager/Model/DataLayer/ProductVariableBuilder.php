...
class ProductVariableBuilder
{
    ...
    public function getVariables(ProductAbstractTransfer $product): array
    {
        ...
        $googleTagManagerProductDetailTransfer = (new GoogleTagManagerProductDetailTransfer())
        ...
        return $this->executePlugins($product, $googleTagManagerProductDetailTransfer->toArray(true, true));
    }
