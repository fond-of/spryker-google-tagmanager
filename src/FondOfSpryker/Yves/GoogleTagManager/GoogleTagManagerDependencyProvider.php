...
class GoogleTagManagerDependencyProvider extends AbstractBundleDependencyProvider
{
    ...
    public const TRANSACTION_PRODUCT_VARIABLE_BUILDER_PLUGIN = 'TRANSACTION_PRODUCT_VARIABLE_BUILDER_PLUGIN';

    public const CATEGORY_VARIABLE_BUILDER_FIELD_PLUGINS = 'CATEGORY_VARIABLE_BUILDER_FIELD_PLUGINS';
    public const CATEGORY_PRODUCT_VARIABLE_BUILDER_PLUGIN = 'CATEGORY_PRODUCT_VARIABLE_BUILDER_PLUGIN';
    ...
    public function provideDependencies(Container $container): Container
    {
        ...
        // Categories
        $this->addCategoryVariableBuilderPlugin($container);
        $this->addCategoryVariableBuilderFieldPlugins($container);
     ...
     * @return \Spryker\Yves\Kernel\Container
     */
    protected function addCategoryVariableBuilderPlugin(Container $container): Container
    {
        $container->set(static::CATEGORY_VARIABLE_BUILDER_PLUGIN, function () {
     ...
     * @return \Spryker\Yves\Kernel\Container
     */
    protected function addCategoryProductVariableBuilderFieldPlugins(Container $container): Container
    {
        $container->set(static::CATEGORY_PRODUCT_VARIABLE_BUILDER_FIELD_PLUGINS, function () {
            return $this->getCategoryProductVariableBuilderFieldPlugins();
        });
     ...
     */
    protected function getCategoryProductVariableBuilderFieldPlugins(): array
    {
        return [];
    }
     ...
     * @return \Spryker\Yves\Kernel\Container
     */
    protected function addCategoryProductVariableBuilderPlugin(Container $container): Container
    {
        $container->set(static::CATEGORY_PRODUCT_VARIABLE_BUILDER_PLUGIN, function () {
            return new CategoryProductVariableBuilderPlugin();
        });
    ...
    {
        $container->set(static::TRANSACTION_PRODUCT_VARIABLE_BUILDER_PLUGIN, function () {
            return new TransactionProductVariableBuilderPlugin();
        });
    ...
    protected function addProductVariableBuilderPlugin(Container $container): Container
    {
        $container->set(static::PRODUCT_VARIABLE_BUILDER_PLUGIN, function () {
            return new ProductVariableBuilderPlugin();
        });
    ...
    protected function addProductVariableBuilderFieldPlugins(Container $container): Container
    {
        $container[static::PRODUCT_VARIABLE_BUILDER_FIELD_PLUGINS] = function () {
            return $this->getProductVariableBuilderFieldPlugins();
        };
    ...
    /**
     * @return \FondOfSpryker\Yves\GoogleTagManager\Dependency\VariableBuilder\ProductFieldPluginInterface[]
     */
    protected function getProductVariableBuilderFieldPlugins(): array
    {
        return [];
    }
     ...
     * @return \Spryker\Yves\Kernel\Container
     */
    protected function addCategoryVariableBuilderFieldPlugins(Container $container): Container
    {
        $container->set(static::CATEGORY_VARIABLE_BUILDER_FIELD_PLUGINS, function () {
            return $this->getCategoryVariableBuilderFieldPlugins();
        });
     ...
     */
    protected function getCategoryVariableBuilderFieldPlugins(): array
    {
        return [];
    }
    ...
    protected function addDefaultVariableBuilderFieldPlugins(Container $container): Container
    {
        $container[static::DEFAULT_VARIABLE_BUILDER_FIELD_PLUGINS] = function () {
            return $this->getDefaultVariableBuilderFieldPlugins();
        };
     ...
     * @return \Spryker\Yves\Kernel\Container
     */
    protected function addQuoteVariableBuilderFieldPlugins(Container $container): Container
    {
        $container[static::QUOTE_VARIABLE_BUILDER_FIELD_PLUGINS] = function () {
    ...
    protected function addTransactionProductVariableBuilderFieldPlugins(Container $container): Container
    {
        $container[static::TRANSACTION_PRODUCT_VARIABLE_BUILDER_FIELD_PLUGINS] = function () {
            return $this->getTransactionProductVariableBuilderFieldPlugins();
        };
