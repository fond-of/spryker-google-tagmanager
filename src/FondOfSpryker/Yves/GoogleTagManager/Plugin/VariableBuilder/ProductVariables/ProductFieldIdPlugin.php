...
class ProductFieldIdPlugin extends AbstractPlugin implements ProductFieldPluginInterface
{
    /**
    ...
    public function handle(
        ...
        return $googleTagManagerProductDetailTransfer->setProductId($product->getIdProductAbstract());
    }
}
