 ...
 */
class DefaultFieldStoreNamePlugin extends AbstractPlugin implements DefaultFieldPluginInterface
{
    /**
    ...
    public function handle(
        ...
        return $googleTagManagerDefaultTransfer->setStore($this->getFactory()->getStore()->getStoreName());
    }
}
