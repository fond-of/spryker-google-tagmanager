 ...
 */
class OrderFieldTransactionAffiliationPlugin extends AbstractPlugin implements OrderFieldPluginInterface
{
    /**
    ...
    public function handle(
        ...
        $googleTagManagerTransactionTransfer->setTransactionAffiliation(
            $this->getFactory()->getStore()->getStoreName()
        );
