 ...
 */
class OrderFieldTransactionEntityPlugin extends AbstractPlugin implements OrderFieldPluginInterface
{
    /**
    ...
    public function handle(
        ...
        $googleTagManagerTransactionTransfer->setTransactionEntity('ORDER');
